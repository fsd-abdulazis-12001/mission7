...
const Index = React.memo(() => {
  ...
  const { data: topRatingFilmAndMovies, isLoading: loadingtopRatingFilmAndMovies, isError: errortopRatingFilmAndMovies } = useFetch('topRatingFilmAndMovies');
  const { data: filmTrandingMovies, isLoading: loadingfilmTrandingMovies, isError: errorfilmTrandingMovies } = useFetch('filmTrandingMovies');
  ...
  return (
    <>
      ...
      <CardsLayouts title="Melanjutkan Tonton Film" height="h-[309px]" amount = {4} isError={errorResumeMovies} isLoading={loadingResumeMovies} >
     ...
     <CardsLayouts title="Top Rating Film dan Series Hari ini" height="h-[512px]" amount = {5} isError={errortopRatingFilmAndMovies} isLoading={loadingtopRatingFilmAndMovies}>
      ...
      <CardsLayouts title="Film Trending" height="h-[512px]" amount = {5} isError={errorfilmTrandingMovies} isLoading={loadingfilmTrandingMovies}>
